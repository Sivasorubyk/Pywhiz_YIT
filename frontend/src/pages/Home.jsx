...
const Home = () => {
  ...
  const faqs = [
    { question: "What is PyWhiz?", answer: "PyWhiz is an AI-powered platform for learning Python." },
    { question: "Why choose us?", answer: "We offer interactive exercises, video tutorials, and AI assistance." },
    { question: "Can anyone follow our application?", answer: "Yes! PyWhiz is designed for beginners aged 11-15." },
    { question: "Why is it great for beginners?", answer: "Simple explanations, hands-on coding, and fun exercises." },
    { question: "Can I improve my Python skills here?", answer: "Absolutely! Our guided lessons and AI support help you grow." },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative cursor-pointer h-[400px]" onClick={() => setSelectedVideo(introVideo)}>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-5xl text-white bg-black bg-opacity-50 px-6 py-4 rounded-full hover:bg-opacity-70">▶</span>
            </div>
          </div>
        </div>
      ...
      {selectedVideo && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center" onClick={() => setSelectedVideo(null)}>
